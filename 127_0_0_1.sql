...
INSERT INTO `student` (`NIM`, `NAMA`, `JK`, `JURUSAN`, `PRODI`, `ALAMAT`, `telepon`) VALUES
('1', 'Zuhrah', '2', 'Sistem Informas', 'S1 SI', 'Depok', NULL),
('2', 'Frida', '2', 'Sistem Informas', 'S1 SI', 'Jakarta', NULL),
('3', 'Khafidh', '2', 'Sistem Informas', 'S1 SI', 'Bogor', NULL),
('4', 'Donny', '2', 'Sistem Informas', 'S1 SI', 'Jakarta', NULL),
('5', 'Keisha', '2', 'Sistem Informas', 'S1 SI', 'Depok', NULL);
...
INSERT INTO `employee` (`employee_id`, `employee_name`, `employee_DOB`, `department_ID`) VALUES
(1, 'alan smith', '1989-01-01', 1),
(2, 'sultan nader', '1992-01-01', 1),
(3, 'mond rasheed', '1999-01-01', 2),
(4, 'brian wallace', '1979-01-01', 3),
...
--
CREATE DATABASE IF NOT EXISTS `dbperusahaan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbperusahaan`;
...
CREATE TABLE `gaji` (
  ...
  `GAJI_KARYAWAN` int(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `gaji` (`KDJABATAN`, `GAJI_KARYAWAN`) VALUES
('J01', 10000000),
('J02', 8000000),
('J03', 5000000),
('J04', 3000000),
...
--
-- Stand-in structure for view `gajimaks`
-- (See below for the actual view)
--
CREATE TABLE `gajimaks` (
`GajiMaksimum` int(20)
);
...
--
-- Stand-in structure for view `gajimin`
-- (See below for the actual view)
--
CREATE TABLE `gajimin` (
`Gajiminimum` int(20)
);
...
('J02', 'WAKIL DIREKTUR'),
('J03', 'SEKRETARIS'),
('J04', 'STAFF PERSONALIA'),
('J05', 'ADMINISTRASI');

-- --------------------------------------------------------

--
-- Stand-in structure for view `jmlgaji`
-- (See below for the actual view)
--
CREATE TABLE `jmlgaji` (
`jumlahgaji` decimal(41,0)
);
...
INSERT INTO `karyawan` (`NIP`, `NAMA`, `ALAMAT`, `KDJABATAN`, `GAJI`) VALUES
('P001', 'DODI ILHAM', 'JL.MERDEKA NO.203', 'J01', NULL),
('P002', 'IRAWAN SANTOSO', 'JL.A.YANI NO.12', 'J02', NULL),
('P003', 'BAMBANG SUJATMIKO', 'JL.BASUKI RAHMAT NO.21', 'J04', NULL),
('P004', 'INDAH PERMATA SARI', 'JL.MAY SABARANO NO.445', 'J03', NULL);

--
-- Triggers `karyawan`
--
DELIMITER $$
CREATE TRIGGER `delete_log_karyawan` AFTER DELETE ON `karyawan` FOR EACH ROW begin
insert into log_karyawan set
kejadian = 'delete',
waktu = now();
end
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `update_log_karyawan` AFTER UPDATE ON `karyawan` FOR EACH ROW begin
insert into log_karyawan set
kejadian = 'update',
waktu = now();
end
...
--
-- Dumping data for table `log_karyawan`
--

INSERT INTO `log_karyawan` (`kejadian`, `waktu`) VALUES
('update', '2022-03-22 11:27:06'),
('update', '2022-03-22 11:28:07'),
('delete', '2022-03-22 11:30:35'),
('update', '2022-03-24 19:33:15'),
('update', '2022-03-24 19:36:00'),
('delete', '2022-03-24 19:41:24'),
('delete', '2022-03-24 19:45:33'),
('update', '2022-03-24 19:52:30'),
('update', '2022-03-24 19:54:31'),
('update', '2022-03-24 19:55:59'),
('delete', '2022-03-24 19:59:44'),
('delete', '2022-03-24 20:01:15');

-- --------------------------------------------------------

--
-- Stand-in structure for view `ratagaji`
-- (See below for the actual view)
--
CREATE TABLE `ratagaji` (
`GajiRatarata` decimal(23,4)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `showkaryawan`
-- (See below for the actual view)
--
CREATE TABLE `showkaryawan` (
`NIP` varchar(10)
,`NAMA` varchar(30)
,`JABATAN` varchar(20)
,`GAJI_KARYAWAN` int(20)
);

-- --------------------------------------------------------

--
-- Structure for view `gajimaks`
--
DROP TABLE IF EXISTS `gajimaks`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `gajimaks`  AS SELECT max(`gaji`.`GAJI_KARYAWAN`) AS `GajiMaksimum` FROM `gaji``gaji`  ;

-- --------------------------------------------------------

--
-- Structure for view `gajimin`
--
DROP TABLE IF EXISTS `gajimin`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `gajimin`  AS SELECT min(`gaji`.`GAJI_KARYAWAN`) AS `Gajiminimum` FROM `gaji``gaji`  ;

-- --------------------------------------------------------

--
-- Structure for view `jmlgaji`
--
DROP TABLE IF EXISTS `jmlgaji`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `jmlgaji`  AS SELECT sum(`gaji`.`GAJI_KARYAWAN`) AS `jumlahgaji` FROM `gaji``gaji`  ;

-- --------------------------------------------------------

--
-- Structure for view `ratagaji`
--
DROP TABLE IF EXISTS `ratagaji`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `ratagaji`  AS SELECT avg(`gaji`.`GAJI_KARYAWAN`) AS `GajiRatarata` FROM `gaji``gaji`  ;

-- --------------------------------------------------------

--
-- Structure for view `showkaryawan`
--
DROP TABLE IF EXISTS `showkaryawan`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `showkaryawan`  AS SELECT `karyawan`.`NIP` AS `NIP`, `karyawan`.`NAMA` AS `NAMA`, `jabatan`.`JABATAN` AS `JABATAN`, `gaji`.`GAJI_KARYAWAN` AS `GAJI_KARYAWAN` FROM ((`karyawan` join `jabatan`) join `gaji`) WHERE `jabatan`.`KDJABATAN` = `karyawan`.`KDJABATAN` AND `gaji`.`KDJABATAN` = `karyawan`.`KDJABATAN``KDJABATAN`  ;
...
-- Database: `db_pentaho`
--
CREATE DATABASE IF NOT EXISTS `db_pentaho` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `db_pentaho`;

-- --------------------------------------------------------

--
-- Table structure for table `tb_play_tennis`
--

CREATE TABLE `tb_play_tennis` (
...
--
-- Dumping data for table `tb_play_tennis`
--

INSERT INTO `tb_play_tennis` (`day`, `outlook`, `temp`, `humidity`, `wind`, `play`) VALUES
...
CREATE TABLE `bahan_baku` (
  ...
  `Jenis Bahan` varchar(20) NOT NULL,
  `Harga Bahan` int(10) NOT NULL,
...
CREATE TABLE `departemen` (
  ...
  `Nama Departemen` varchar(30) NOT NULL,
...
CREATE TABLE `dosen` (
  ...
  `jabfung` varchar(20) DEFAULT NULL,
  `jk_dosen` enum('L','P') DEFAULT NULL,
  `nohp_dosen` varchar(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `gaji` (
  ...
  `Jumlah Gaji` int(20) NOT NULL,
  `Jumlah Lembur` int(10) NOT NULL,
  `Insentif` int(20) NOT NULL,
  `Potongan` int(20) NOT NULL,
  `Total` int(25) NOT NULL,
  `Tanggal Penerimaan` date NOT NULL,
...
CREATE TABLE `mesin` (
  ...
  `Nama Mesin` varchar(20) NOT NULL,
  `Harga Mesin` int(20) NOT NULL,
  `Tahun Pembelian` year(4) NOT NULL,
  `Jumlah Mesin` int(10) NOT NULL,
  `Id_Departemen` int(10) NOT NULL,
  `Nama Perusahaan` varchar(30) NOT NULL,
  `Keterangan` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `pemasok` (
  ...
  `Nama Pemasok` varchar(20) NOT NULL,
  `Alamat` int(40) NOT NULL,
  `Kota` int(20) NOT NULL,
  `No. Telepon` int(20) NOT NULL,
  `No. Rekening` int(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- --------------------------------------------------------

--
-- Table structure for table `pembayaran_pelanggan`
--
...
CREATE TABLE `pembayaran_pelanggan` (
  ...
  `Total Pembayaran` int(30) NOT NULL,
...
--
-- Table structure for table `pembayaran_pemasok`
--

CREATE TABLE `pembayaran_pemasok` (
  `Id_Pembayaran` int(10) NOT NULL,
  `Total Pembayaran` int(11) NOT NULL,
  `Tgl_Pembayaran` date NOT NULL,
  `Id_Pemasok` int(10) NOT NULL,
  `Kode_Bahan` int(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `produksi` (
  ...
  `Tanggal Produksi` int(11) NOT NULL,
  `Waktu Produksi` int(11) NOT NULL,
...
--
-- Indexes for table `pembayaran_pelanggan`
--
ALTER TABLE `pembayaran_pelanggan`
  ADD PRIMARY KEY (`Id_Pembayaran`),
  ADD KEY `transaksi_ibfk_1` (`Id_Produk`),
  ADD KEY `transaksi_ibfk_2` (`Id_Pelanggan`);

--
-- Indexes for table `pembayaran_pemasok`
--
ALTER TABLE `pembayaran_pemasok`
  ADD PRIMARY KEY (`Id_Pembayaran`),
  ADD KEY `pembayaran_ibfk_1` (`Id_Pemasok`),
...
ALTER TABLE `produksi`
  ...
  ADD KEY `produksi_ibfk_1` (`Id_Produk`),
...
--
ALTER TABLE `jadwal`
  ADD CONSTRAINT `jadwal_ibfk_1` FOREIGN KEY (`kode_matkul`) REFERENCES `mata_kuliah` (`kode_matkul`),
  ADD CONSTRAINT `jadwal_ibfk_2` FOREIGN KEY (`kode_dosen`) REFERENCES `dosen` (`kode_dosen`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `khs`
  ...
  ADD CONSTRAINT `khs_ibfk_2` FOREIGN KEY (`kode_matkul`) REFERENCES `mata_kuliah` (`kode_matkul`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Database: `dummy_db`
--
CREATE DATABASE IF NOT EXISTS `dummy_db` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `dummy_db`;
...
CREATE TABLE `dummy_table` (
  ...
  `university` varchar(52) DEFAULT NULL,
...
INSERT INTO `dummy_table` (`id`, `name`, `email`, `gender`, `university`, `country`) VALUES
(1, 'Madison Kent', 'Madison_Kent8725@hourpy.biz', 'Female', 'The University of Georgia', 'Ukraine'),
(2, 'Harry Ulyatt', 'Harry_Ulyatt9294@deavo.com', 'Male', 'University of Miami', 'China'),
(3, 'Karla Strong', 'Karla_Strong6502@gompie.com', 'Female', 'University of California, San Diego (UCSD)', 'Denmark'),
(4, 'Bart Greenwood', 'Bart_Greenwood8506@vetan.org', 'Male', 'University of Delaware', 'Samoa'),
(5, 'Tyson Scott', 'Tyson_Scott8437@yahoo.com', 'Male', 'University of Pittsburgh', 'Estonia'),
(6, 'Cassidy May', 'Cassidy_May7214@bretoux.com', 'Female', 'University of Rochester', 'Nicaragua'),
(7, 'Alessia Antcliff', 'Alessia_Antcliff2961@nanoff.biz', 'Female', 'Drexel University', 'Cambodia'),
(8, 'Tiffany Thomas', 'Tiffany_Thomas3991@brety.org', 'Female', 'Cornell University', 'Czech Republic'),
(9, 'Elijah Hale', 'Elijah_Hale3535@naiker.biz', 'Male', 'University of Pennsylvania', 'Nauru'),
(10, 'Adeline Faulkner', 'Adeline_Faulkner7428@acrit.org', 'Female', 'Oregon State University', 'Grenada'),
(11, 'Rocco Jordan', 'Rocco_Jordan216@extex.org', 'Male', 'University of Iowa', 'Congo, Republic of the'),
(12, 'Remy Swan', 'Remy_Swan7157@hourpy.biz', 'Female', 'University of Illinois, Chicago (UIC)', 'Czech Republic'),
(13, 'Nathan Nelson', 'Nathan_Nelson7199@infotech44.tech', 'Male', 'Cornell University', 'France'),
(14, 'Chadwick Furnell', 'Chadwick_Furnell5812@tonsy.org', 'Male', 'Rensselaer Polytechnic University', 'Argentina'),
(15, 'Manuel Ryan', 'Manuel_Ryan9955@bretoux.com', 'Male', 'Massachusets Institute of Technology', 'Argentina'),
(16, 'David Olivier', 'David_Olivier5820@fuliss.net', 'Male', 'University of Kansas', 'Monaco'),
(17, 'Emerald Notman', 'Emerald_Notman3361@deavo.com', 'Female', 'University of California, San Diego (UCSD)', 'Mali'),
(18, 'Candice Ellwood', 'Candice_Ellwood8724@dionrab.com', 'Female', 'Georgetown University', 'Slovakia'),
(19, 'Eduardo Jefferson', 'Eduardo_Jefferson1805@dionrab.com', 'Male', 'University of Delaware', 'Uzbekistan'),
(20, 'Adalind Weatcroft', 'Adalind_Weatcroft2382@guentu.biz', 'Female', 'Dartmouth College', 'Zambia'),
(21, 'Moira Holt', 'Moira_Holt3126@guentu.biz', 'Female', 'Northwestern University', 'Korea, North'),
(22, 'Daria Button', 'Daria_Button1038@ovock.tech', 'Female', 'Wake Forest University', 'Nauru'),
(23, 'Bree Devonport', 'Bree_Devonport6175@elnee.tech', 'Female', 'University of Hawai', 'Thailand'),
(24, 'Cynthia Parker', 'Cynthia_Parker6253@deons.tech', 'Female', 'Pennsylvania State University', 'Cameroon'),
(25, 'Angelique Shelton', 'Angelique_Shelton7160@twipet.com', 'Female', 'The Katz School at Yeshiva University', 'Equatorial Guinea'),
(26, 'Aiden Holmes', 'Aiden_Holmes4129@nimogy.biz', 'Male', 'Vanderbilt University', 'Madagascar'),
(27, 'Gladys Vernon', 'Gladys_Vernon4227@deons.tech', 'Female', 'Tufts University', 'Comoros'),
(28, 'Erin Rowlands', 'Erin_Rowlands2575@vetan.org', 'Female', 'Rensselaer Polytechnic University', 'Lesotho'),
(29, 'Allison Hogg', 'Allison_Hogg8666@typill.biz', 'Female', 'Tulane University', 'Guyana'),
(30, 'Oliver Stone', 'Oliver_Stone6223@deons.tech', 'Male', 'University of Maryland, College Park', 'Fiji'),
(31, 'Carmella Walsh', 'Carmella_Walsh5747@twipet.com', 'Female', 'Iowa State University', 'France'),
(32, 'Rufus Dale', 'Rufus_Dale5559@qater.org', 'Male', 'University of Pittsburgh', 'Afghanistan'),
(33, 'Harry Johnson', 'Harry_Johnson6983@joiniaa.com', 'Male', 'Texas A&M University', 'Angola'),
(34, 'Daron Webster', 'Daron_Webster4273@deavo.com', 'Male', 'Rice University', 'Kiribati'),
(35, 'Cassidy Michael', 'Cassidy_Michael9529@sveldo.biz', 'Female', 'Florida State University', 'Guinea'),
(36, 'Selena Ellwood', 'Selena_Ellwood1538@liret.org', 'Female', 'University of Michigan', 'Finland'),
(37, 'Jamie Kennedy', 'Jamie_Kennedy8673@bulaffy.com', 'Female', 'University of Delaware', 'El Salvador'),
(38, 'Elijah Speed', 'Elijah_Speed2030@naiker.biz', 'Male', 'Johns Hopkins University', 'Portugal'),
(39, 'Leanne Edmonds', 'Leanne_Edmonds7304@sveldo.biz', 'Female', 'University of Hawai', 'Costa Rica'),
(40, 'Michelle Beal', 'Michelle_Beal226@fuliss.net', 'Female', 'University of California, Riverside', 'Ukraine'),
(41, 'Enoch Wild', 'Enoch_Wild7485@cispeto.com', 'Male', 'Northeastern University', 'Armenia'),
(42, 'Holly Wright', 'Holly_Wright5537@qater.org', 'Female', 'The New School', 'Libya'),
(43, 'Stephanie Ebden', 'Stephanie_Ebden5062@elnee.tech', 'Female', 'University of Oklahoma', 'Afghanistan'),
(44, 'John Parsons', 'John_Parsons4402@tonsy.org', 'Male', 'University of California, Santa Barbara (UCSB)', 'Korea, South'),
(45, 'Candace Graham', 'Candace_Graham8722@bungar.biz', 'Female', 'University at Buffalo SUNY', 'Poland'),
(46, 'Aleksandra Power', 'Aleksandra_Power3985@cispeto.com', 'Female', 'Duke University', 'Turkey'),
(47, 'Harmony Chapman', 'Harmony_Chapman8156@qater.org', 'Female', 'The University of Georgia', 'Saint Kitts and Nevis'),
(48, 'Isla Russel', 'Isla_Russel6401@kideod.biz', 'Female', 'Washington State University', 'Croatia'),
(49, 'Crystal Haines', 'Crystal_Haines9794@sveldo.biz', 'Female', 'University of Colorado, Denver', 'Thailand'),
(50, 'Willow Warren', 'Willow_Warren7984@hourpy.biz', 'Female', 'University of Virginia', 'United Kingdom'),
(51, 'Agnes Stubbs', 'Agnes_Stubbs3060@elnee.tech', 'Female', 'California Institute of Technology (Caltech)', 'Paraguay'),
(52, 'Zara Brown', 'Zara_Brown3171@typill.biz', 'Female', 'Washington University in St. Louis', 'Bahrain'),
(53, 'Angela Wood', 'Angela_Wood8158@zorer.org', 'Female', 'University of Texas Dallas', 'Guinea-Bissau'),
(54, 'Hadley Kerr', 'Hadley_Kerr7992@sveldo.biz', 'Female', 'University of Chicago', 'Bulgaria'),
(55, 'Emery Rainford', 'Emery_Rainford9521@bungar.biz', 'Female', 'University of California, Irvine', 'Pakistan'),
(56, 'Joseph Bowen', 'Joseph_Bowen736@eirey.tech', 'Male', 'Cornell University', 'Swaziland'),
(57, 'Henry Stark', 'Henry_Stark7300@fuliss.net', 'Male', 'Yale University', 'Denmark'),
(58, 'Kurt Wright', 'Kurt_Wright8256@muall.tech', 'Male', 'University of North Carolina, Chapel Hill', 'Ethiopia'),
(59, 'Belinda Uttridge', 'Belinda_Uttridge1735@cispeto.com', 'Female', 'Indiana University Bloomington', 'Portugal'),
(60, 'Jolene Graves', 'Jolene_Graves3805@ubusive.com', 'Female', 'Vanderbilt University', 'Tajikistan'),
(61, 'Maxwell Collingwood', 'Maxwell_Collingwood1138@iatim.tech', 'Male', 'University of Maryland, College Park', 'Mauritania'),
(62, 'Rhea Hale', 'Rhea_Hale1317@elnee.tech', 'Female', 'University of Illinois, Chicago (UIC)', 'El Salvador'),
(63, 'David Cann', 'David_Cann1717@fuliss.net', 'Male', 'Wake Forest University', 'Hungary'),
(64, 'Marvin Tindall', 'Marvin_Tindall2619@guentu.biz', 'Male', 'University of Pennsylvania', 'Portugal'),
(65, 'Manuel Pope', 'Manuel_Pope2970@guentu.biz', 'Male', 'Florida State University', 'Ireland'),
(66, 'Boris Richards', 'Boris_Richards5915@mafthy.com', 'Male', 'Arizona State University', 'Sao Tome and Principe'),
(67, 'Hope Tutton', 'Hope_Tutton6313@corti.com', 'Female', 'Northeastern University', 'Bhutan'),
(68, 'Alex Khan', 'Alex_Khan8225@mafthy.com', 'Female', 'University of North Carolina, Chapel Hill', 'Armenia'),
(69, 'Marina Gordon', 'Marina_Gordon1108@fuliss.net', 'Female', 'Northwestern University', 'Suriname'),
(70, 'Cedrick Garcia', 'Cedrick_Garcia3083@mafthy.com', 'Male', 'Carnegie Mellon University', 'Nigeria'),
(71, 'Joseph Hewitt', 'Joseph_Hewitt4091@dionrab.com', 'Male', 'The New School', 'Myanmar'),
(72, 'Rae Jackson', 'Rae_Jackson8124@kideod.biz', 'Female', 'Washington State University', 'Argentina'),
(73, 'Russel Blackwall', 'Russel_Blackwall1054@grannar.com', 'Male', 'George Washington University', 'Kyrgyzstan'),
(74, 'Ramon Rodwell', 'Ramon_Rodwell5732@dionrab.com', 'Male', 'University of Delaware', 'India'),
(75, 'Nick Patel', 'Nick_Patel9835@extex.org', 'Male', 'Emory University', 'Slovenia'),
(76, 'Kate Whinter', 'Kate_Whinter2996@yahoo.com', 'Female', 'Stony Brook University, State University of New York', 'Chile'),
(77, 'Aurelia Simmons', 'Aurelia_Simmons6838@gembat.biz', 'Female', 'The Katz School at Yeshiva University', 'Norway'),
(78, 'Peter Lloyd', 'Peter_Lloyd2964@gembat.biz', 'Male', 'Colorado State University', 'USA'),
(79, 'Faith Jackson', 'Faith_Jackson5003@sveldo.biz', 'Female', 'Howard University', 'Greece'),
(80, 'Josephine Potts', 'Josephine_Potts8726@twace.org', 'Female', 'Rutgers University - New Brunswick', 'Gabon'),
(81, 'Gabriel Baldwin', 'Gabriel_Baldwin6450@cispeto.com', 'Male', 'Iowa State University', 'Liberia'),
(82, 'Erica Hamilton', 'Erica_Hamilton5996@bungar.biz', 'Female', 'University of Miami', 'Senegal'),
(83, 'Gabriel Hudson', 'Gabriel_Hudson6057@elnee.tech', 'Male', 'Colorado State University', 'Bahrain'),
(84, 'Irene Hamilton', 'Irene_Hamilton2900@infotech44.tech', 'Female', 'University of New Mexico', 'Côte d’Ivoire'),
(85, 'Joseph Donnelly', 'Joseph_Donnelly7442@elnee.tech', 'Male', 'Howard University', 'Sri Lanka'),
(86, 'Anabelle Rodwell', 'Anabelle_Rodwell251@hourpy.biz', 'Female', 'Arizona State University', 'Turkmenistan'),
(87, 'Emely Addison', 'Emely_Addison9384@gmail.com', 'Female', 'The Ohio State University', 'Dominican Republic'),
(88, 'Liv Lewis', 'Liv_Lewis6749@jiman.org', 'Female', 'Georgetown University', 'Central African Republic'),
(89, 'Scarlett Baker', 'Scarlett_Baker2694@fuliss.net', 'Female', 'Georgetown University', 'Germany'),
(90, 'Louise Corbett', 'Louise_Corbett3220@grannar.com', 'Female', 'Texas A&M University', 'Sierra Leone'),
(91, 'Natalie Bennett', 'Natalie_Bennett6477@liret.org', 'Female', 'Rutgers University - New Brunswick', 'New Zealand'),
(92, 'Noah Bullock', 'Noah_Bullock7111@fuliss.net', 'Male', 'University of California, Davis', 'Germany'),
(93, 'Mabel Warden', 'Mabel_Warden9367@womeona.net', 'Female', 'Northwestern University', 'Tanzania'),
(94, 'Owen Palmer', 'Owen_Palmer891@corti.com', 'Male', 'University of Michigan', 'Moldova'),
(95, 'Adalind Griffiths', 'Adalind_Griffiths4217@bretoux.com', 'Female', 'University of Florida', 'Equatorial Guinea'),
(96, 'Eduardo Jacobs', 'Eduardo_Jacobs4912@gompie.com', 'Male', 'Case Western Reserve University', 'Tunisia'),
(97, 'Holly Hill', 'Holly_Hill3060@mafthy.com', 'Female', 'University of Oklahoma', 'Japan'),
(98, 'Aurelia Bristow', 'Aurelia_Bristow7210@brety.org', 'Female', 'Washington University in St. Louis', 'Belize'),
(99, 'Ivy Brown', 'Ivy_Brown5961@gembat.biz', 'Female', 'The University of Arizona', 'Yemen'),
(100, 'Rosalie Nurton', 'Rosalie_Nurton2828@bulaffy.com', 'Female', 'Carnegie Mellon University', 'Seychelles'),
(101, 'Tom Faulkner', 'Tom_Faulkner9129@extex.org', 'Male', 'University of Oklahoma', 'Cabo Verde'),
(102, 'Esmeralda Nelson', 'Esmeralda_Nelson7084@bretoux.com', 'Female', 'University of Pittsburgh', 'Sierra Leone'),
(103, 'Livia Whinter', 'Livia_Whinter7692@typill.biz', 'Female', 'New York University', 'Lesotho'),
(104, 'Adalie Evans', 'Adalie_Evans3844@vetan.org', 'Female', 'Howard University', 'Syria'),
(105, 'Harvey Woodley', 'Harvey_Woodley6447@atink.com', 'Male', 'Northeastern University', 'Zambia'),
(106, 'David Tobin', 'David_Tobin9380@irrepsy.com', 'Male', 'University of California, Riverside', 'Kenya'),
(107, 'Hannah Egerton', 'Hannah_Egerton9518@qater.org', 'Female', 'Washington State University', 'Jordan'),
(108, 'Bristol Vane', 'Bristol_Vane6777@nickia.com', 'Female', 'George Washington University', 'Ghana'),
(109, 'Daron Sinclair', 'Daron_Sinclair8123@vetan.org', 'Male', 'University of Maryland, Baltimore County', 'Barbados'),
(110, 'Lillian Baker', 'Lillian_Baker8797@ovock.tech', 'Female', 'University of Hawai', 'Moldova'),
(111, 'Faith Collis', 'Faith_Collis8351@nanoff.biz', 'Female', 'Purdue University', 'China'),
(112, 'Quinn Shields', 'Quinn_Shields3354@jiman.org', 'Female', 'Pennsylvania State University', 'Micronesia'),
(113, 'Evelynn Ulyatt', 'Evelynn_Ulyatt587@gembat.biz', 'Female', 'University of Florida', 'Ghana'),
(114, 'Benjamin Knight', 'Benjamin_Knight982@qater.org', 'Male', 'Boston College', 'Malaysia'),
(115, 'Ethan Corbett', 'Ethan_Corbett4617@dionrab.com', 'Male', 'University of Texas at Austin', 'Azerbaijan'),
(116, 'Daniel Benson', 'Daniel_Benson3998@twace.org', 'Male', 'University of Michigan', 'Peru'),
(117, 'Phillip Adler', 'Phillip_Adler9390@gompie.com', 'Male', 'University of Texas at Austin', 'Malta'),
(118, 'Phillip Andersson', 'Phillip_Andersson6647@extex.org', 'Male', 'University of Notre Dame', 'Russia'),
(119, 'Phillip Jarrett', 'Phillip_Jarrett8389@fuliss.net', 'Male', 'Drexel University', 'Greece'),
(120, 'Tess Lewin', 'Tess_Lewin2940@brety.org', 'Female', 'University of Iowa', 'USA'),
(121, 'Nathan Tait', 'Nathan_Tait4835@gmail.com', 'Male', 'University of California, Los Angeles (UCLA)', 'Liechtenstein'),
(122, 'Danny Yard', 'Danny_Yard2745@nickia.com', 'Male', 'The University of Tennessee, Knoxville', 'Macedonia'),
(123, 'Leslie Woods', 'Leslie_Woods7587@naiker.biz', 'Female', 'University of Virginia', 'Monaco'),
(124, 'Holly Walsh', 'Holly_Walsh3456@kideod.biz', 'Female', 'University of Delaware', 'Kosovo'),
(125, 'Daron Wilkinson', 'Daron_Wilkinson6842@ovock.tech', 'Male', 'Howard University', 'Eritrea'),
(126, 'Cassidy Hardwick', 'Cassidy_Hardwick3631@famism.biz', 'Female', 'University of Pennsylvania', 'Bosnia and Herzegovina'),
(127, 'Owen Parker', 'Owen_Parker7289@corti.com', 'Male', 'University of California, Riverside', 'Cabo Verde'),
(128, 'Matt Penn', 'Matt_Penn5926@gmail.com', 'Male', 'Harvard University', 'China'),
(129, 'Louise Kelly', 'Louise_Kelly4977@mafthy.com', 'Female', 'University of Vermont', 'Cabo Verde'),
(130, 'Leslie Durrant', 'Leslie_Durrant9286@corti.com', 'Female', 'University of Pennsylvania', 'Zimbabwe'),
(131, 'Angelina Webster', 'Angelina_Webster6730@extex.org', 'Female', 'Washington University in St. Louis', 'Sweden'),
(132, 'Jack Benson', 'Jack_Benson5977@tonsy.org', 'Male', 'Rutgers University - New Brunswick', 'Burundi'),
(133, 'Owen Jarrett', 'Owen_Jarrett1192@bulaffy.com', 'Male', 'Harvard University', 'Laos'),
(134, 'Hayden Norman', 'Hayden_Norman9224@gembat.biz', 'Male', 'University at Buffalo SUNY', 'Trinidad and Tobago'),
(135, 'Julius Daniells', 'Julius_Daniells1671@acrit.org', 'Male', 'University of Rochester', 'Ukraine'),
(136, 'Rufus Tobin', 'Rufus_Tobin5013@ubusive.com', 'Male', 'Georgia Institute of Technology', 'Comoros'),
(137, 'Carla Lindsay', 'Carla_Lindsay7421@tonsy.org', 'Female', 'Georgia Institute of Technology', 'Kazakhstan'),
(138, 'Penelope Swan', 'Penelope_Swan7603@irrepsy.com', 'Female', 'Arizona State University', 'Cabo Verde'),
(139, 'Ruth Morrow', 'Ruth_Morrow4758@tonsy.org', 'Female', 'University of California, Los Angeles (UCLA)', 'Vanuatu'),
(140, 'Clint Cavanagh', 'Clint_Cavanagh7573@deavo.com', 'Male', 'University of Maryland, College Park', 'Tanzania'),
(141, 'Emely Eastwood', 'Emely_Eastwood7666@iatim.tech', 'Female', 'University of California, Santa Cruz', 'China'),
(142, 'Daniel Seymour', 'Daniel_Seymour6770@iatim.tech', 'Male', 'Brandeis University', 'Ecuador'),
(143, 'Alexander Jackson', 'Alexander_Jackson808@gembat.biz', 'Male', 'Georgetown University', 'Andorra'),
(144, 'Bryce Gosling', 'Bryce_Gosling5807@famism.biz', 'Female', 'University of Hawai', 'Tonga'),
(145, 'Manuel Shepherd', 'Manuel_Shepherd8041@gmail.com', 'Male', 'University of Notre Dame', 'Central African Republic'),
(146, 'Nathan Cattell', 'Nathan_Cattell3716@grannar.com', 'Male', 'University of California, Irvine', 'Djibouti'),
(147, 'Rufus Burge', 'Rufus_Burge5405@naiker.biz', 'Male', 'Virginia Polytechnic Institute and State University', 'Sweden'),
(148, 'Liam Booth', 'Liam_Booth9993@eirey.tech', 'Male', 'The University of Arizona', 'Malaysia'),
(149, 'Celia Heaton', 'Celia_Heaton9827@nimogy.biz', 'Female', 'Howard University', 'Switzerland'),
(150, 'Bryon Walker', 'Bryon_Walker6983@brety.org', 'Male', 'Oregon State University', 'Korea, North');
...
-- Database: `himpunan`
--
CREATE DATABASE IF NOT EXISTS `himpunan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `himpunan`;
...
CREATE TABLE `anggota` (
  ...
  `status` enum('AB','ALB') DEFAULT NULL,
  `tahun_masuk` int(10) DEFAULT NULL,
  `jalur_masuk` enum('SNMPTN','SBMPTN','Mandiri') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- Database: `kasus1`
--
CREATE DATABASE IF NOT EXISTS `kasus1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `kasus1`;
...
(2, 'Buku Sidu', 'A001', 1, 5, 5000, 0, '2022-02-23 21:04:13', '2022-02-23 21:04:13'),
(4, 'Aqua', 'A002', 5, 2, 3000, 26, '2022-02-23 21:04:13', '2022-02-23 21:04:13'),
(5, 'Pensil 2B', 'A003', 1, 5, 25000, 95, '2022-02-23 21:04:13', '2022-02-23 21:04:13');
...
-- Database: `kasus2`
--
CREATE DATABASE IF NOT EXISTS `kasus2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `kasus2`;
--
-- Database: `latihanprak`
--
CREATE DATABASE IF NOT EXISTS `latihanprak` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `latihanprak`;
...
CREATE TABLE `pegawai` (
  ...
  `Nm_peg` varchar(20) DEFAULT NULL,
...
INSERT INTO `pegawai` (`NIK`, `Nm_peg`, `Tmp_lhr`, `Alamat`, `Status`, `Jml_anak`, `Id_jabatan`) VALUES
('96008', 'Qonita', 'Jakarta', 'Jakarta', 'Menikah', 3, '2'),
('96010', 'Aldin', 'Tangerang', 'Tangerang', 'Belum', 0, '1'),
('97001', 'Syakira', 'Jakarta', 'Jakarta', 'Menikah', 2, '3'),
('98003', 'Khalid', 'Bandung', 'Bandung', 'Belum', 0, '1'),
('98020', 'Nayla', 'Bogor', 'Bogor', 'Menikah', 3, '3'),
('99003', 'Nadhira', 'Jakarta', 'Jakarta', 'Belum', 1, '2');
...
CREATE TABLE `transaksipenjualan` (
  ...
  `nm_costumer` varchar(20) DEFAULT NULL,
  `kd_brg` int(30) DEFAULT NULL,
  `jns_brg` varchar(20) DEFAULT NULL,
  `nm_brg` varchar(25) DEFAULT NULL,
  `jml_brg` int(2) DEFAULT NULL,
  `hrg_sat` int(12) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `transaksipenjualan` (`no_faktur`, `nm_costumer`, `kd_brg`, `jns_brg`, `nm_brg`, `jml_brg`, `hrg_sat`) VALUES
('f10', 'Nadhira', 10, 'Elektronik', 'Kulkas', 1, 3000000),
('f12', 'Jeje', 15, 'Furniture', 'Sofa', 1, 2500000),
('f2', 'Qonita', 11, 'Elektronik', 'Kulkas', 2, 3000000),
('f3', 'Syakira', 13, 'Elektronik', 'TV', 2, 3500000),
('f4', 'Aldin', 30, 'Tool', 'Tangga', 2, 750000),
('f5', 'Nayla', 10, 'Furniture', 'Kursi Tamu', 1, 4500000),
('f8', 'Khalid', 10, 'Furniture', 'Kursi Makan', 1, 4000000),
('f9', 'Michelle', NULL, NULL, NULL, NULL, NULL);
...
--
-- Database: `latihan_case`
--
CREATE DATABASE IF NOT EXISTS `latihan_case` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `latihan_case`;
...
INSERT INTO `nilai_mhs` (`id_nilai`, `nim`, `nilai`, `status`) VALUES
(1, '11111', 80, NULL),
(2, '11112', 50, NULL);
...
--
CREATE DATABASE IF NOT EXISTS `new_database` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `new_database`;
--
-- Database: `pert9`
--
CREATE DATABASE IF NOT EXISTS `pert9` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pert9`;
...
(111, 129, 'Good Fifht', 'Action', 2010),
...
--
-- Table structure for table `deret1`
--
...
--
-- Dumping data for table `deret1`
--

INSERT INTO `deret1` (`nilai`) VALUES
(0),
(2),
(4),
(6),
...
--
CREATE DATABASE IF NOT EXISTS `perusahaan_pakaian` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `perusahaan_pakaian`;
...
--
-- Constraints for table `log_pemesanan`
--
ALTER TABLE `log_pemesanan`
...
('root', '[{\"db\":\"produk_pakaian2\",\"table\":\"hoodie2\"},{\"db\":\"produk_pakaian2\",\"table\":\"tshirt2\"},{\"db\":\"tokopakaian\",\"table\":\"produk_pakaian\"},{\"db\":\"resto\",\"table\":\"order_b\"},{\"db\":\"resto\",\"table\":\"menu\"},{\"db\":\"resto\",\"table\":\"meja\"},{\"db\":\"resto\",\"table\":\"detail_order\"},{\"db\":\"perusahaan_pakaian\",\"table\":\"bahan_baku\"},{\"db\":\"tokopakaian\",\"table\":\"bahan_baku\"},{\"db\":\"tokopakaian\",\"table\":\"produk\"}]');
...
('root', 'resto', 'menu', '{\"sorted_col\":\"`menu`.`kd_menu` ASC\"}', '2022-09-09 02:09:05');
...
('root', '2022-12-04 12:04:36', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":228}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Database: `produk_pakaian2`
--
CREATE DATABASE IF NOT EXISTS `produk_pakaian2` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `produk_pakaian2`;

-- --------------------------------------------------------

--
-- Table structure for table `hoodie2`
--

CREATE TABLE `hoodie2` (
...
--
-- Dumping data for table `hoodie2`
--

INSERT INTO `hoodie2` (`id_produk`, `warna`, `harga`) VALUES
('X002', 'Putih', 45000),
('X009', 'Hitam', 100000),
('X011', 'Biru', 140000);
...
--
-- Table structure for table `kemeja2`
--

CREATE TABLE `kemeja2` (
  `id_produk` varchar(5) NOT NULL,
  `warna` varchar(20) DEFAULT NULL,
  `harga` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `kemeja2`
--

INSERT INTO `kemeja2` (`id_produk`, `warna`, `harga`) VALUES
('X004', 'Hitam', 80000),
('X006', 'Biru', 70000),
('X010', 'Mustard', 95000);
...
('X011', 'R003', 'Hoodie', 'Biru', 140000, 30),
('X012', 'R001', 'T-shirt', 'Biru', 60000, 30);

-- --------------------------------------------------------

--
-- Table structure for table `tshirt2`
--

CREATE TABLE `tshirt2` (
  `id_produk` varchar(5) NOT NULL,
  `warna` varchar(20) DEFAULT NULL,
  `harga` int(10) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `tshirt2`
--

INSERT INTO `tshirt2` (`id_produk`, `warna`, `harga`) VALUES
('X001', 'Hitam', 60000),
('X012', 'Biru', 130000);
...
--
-- Indexes for table `hoodie2`
--
ALTER TABLE `hoodie2`
  ADD PRIMARY KEY (`id_produk`);

--
-- Indexes for table `kemeja2`
--
ALTER TABLE `kemeja2`
  ADD PRIMARY KEY (`id_produk`);
...
CREATE TABLE `detail_order` (
  `no_detail_order` varchar(4) NOT NULL,
...
INSERT INTO `detail_order` (`no_detail_order`, `no_order`, `kd_menu`, `qty`) VALUES
('DO01', 'OD01', 'M01', 2),
('DO02', 'OD01', 'M03', 2),
('DO03', 'OD02', 'M01', 4),
('DO04', 'OD02', 'M03', 4),
...
INSERT INTO `meja` (`no_meja`, `nomor`, `tuple_id`) VALUES
('M01', 1, 1),
('M02', 2, 2),
('M03', 3, 3),
('M04', 4, 4),
...
--
-- Table structure for table `meja_2`
--
...
--
-- Dumping data for table `meja_2`
--

INSERT INTO `meja_2` (`tuple_id`, `kapasitas`, `type`) VALUES
(1, 4, '0'),
(2, 4, '1'),
(3, 5, '0'),
(4, 5, '1'),
...
INSERT INTO `menu` (`kd_menu`, `nm_menu`, `harga`) VALUES
('M01', 'Nasi Goreng', 50000),
('M02', 'Nasi Uduk', 30000),
('M03', 'Es Teh Manis', 5000),
('M04', 'Teh Anget', 3000),
('M05', 'Cheese Pizza', 40000),
('M06', 'Cheese Burger', 25000),
('M07', 'Spagheti', 30000),
('M08', 'Special Bento', 33000),
('M09', 'Gurame Goreng', 45000),
('M10', 'Gurame Bakar Madu', 40000),
('M11', 'Gurame Tepung Asam Manis', 40000),
('M12', 'Gurame Fillet Rica Rica', 50000);

-- --------------------------------------------------------

--
-- Table structure for table `menu_bekasi`
--

CREATE TABLE `menu_bekasi` (
  `kd_menu` varchar(4) NOT NULL,
  `nm_menu` varchar(25) NOT NULL,
  `harga` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `menu_bekasi`
--

INSERT INTO `menu_bekasi` (`kd_menu`, `nm_menu`, `harga`) VALUES
('M09', 'Gurame Goreng', 45000),
('M10', 'Gurame Bakar Madu', 40000),
('M11', 'Gurame Tepung Asam Manis', 40000),
('M12', 'Gurame Fillet Rica Rica', 50000);
...
--
-- Table structure for table `menu_depok`
--

CREATE TABLE `menu_depok` (
  `kd_menu` varchar(4) NOT NULL,
  `nm_menu` varchar(25) NOT NULL,
  `harga` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `menu_depok`
--

INSERT INTO `menu_depok` (`kd_menu`, `nm_menu`, `harga`) VALUES
('M01', 'Nasi Goreng', 50000),
('M02', 'Nasi Uduk', 30000),
('M03', 'Es Teh Manis', 5000),
('M04', 'Teh Anget', 3000);
...
--
-- Table structure for table `menu_jaksel`
--

CREATE TABLE `menu_jaksel` (
  `kd_menu` varchar(4) NOT NULL,
  `nm_menu` varchar(25) NOT NULL,
  `harga` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `menu_jaksel`
--

INSERT INTO `menu_jaksel` (`kd_menu`, `nm_menu`, `harga`) VALUES
('M05', 'Cheese Pizza', 40000),
('M06', 'Cheese Burger', 25000),
('M07', 'Spagheti', 30000),
('M08', 'Special Bento', 33000);
...
--
-- Table structure for table `order_b`
--
...
--
-- Dumping data for table `order_b`
--

INSERT INTO `order_b` (`no_order`, `no_meja`, `tgl`, `jml_item`, `ttl_bayar`) VALUES
('OD01', 'M01', '2015-10-03', 4, 110000),
('OD02', 'M02', '2015-10-03', 4, 100000),
('OD03', 'M03', '2015-10-04', 6, 120000),
('OD04', 'M03', '2015-10-04', 6, 120000),
('OD05', 'M03', '2015-10-04', 6, 120000),
('OD06', 'M04', '2015-10-03', 8, 200000),
('OD07', 'M04', '2015-10-04', 8, 200000),
('OD08', 'M05', '2015-10-05', 8, 1600000),
('OD09', 'M05', '2015-10-05', 4, 100000),
('OD10', 'M01', '2015-10-05', 10, 250000);
...
--
-- Indexes for table `menu_bekasi`
--
ALTER TABLE `menu_bekasi`
  ADD PRIMARY KEY (`kd_menu`);

--
-- Indexes for table `menu_depok`
--
ALTER TABLE `menu_depok`
  ADD PRIMARY KEY (`kd_menu`);

--
-- Indexes for table `menu_jaksel`
--
ALTER TABLE `menu_jaksel`
  ADD PRIMARY KEY (`kd_menu`);

--
-- Indexes for table `order_b`
--
ALTER TABLE `order_b`
...
--
ALTER TABLE `meja`
  MODIFY `tuple_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
--
-- Database: `restore_dbperusahaan`
--
CREATE DATABASE IF NOT EXISTS `restore_dbperusahaan` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `restore_dbperusahaan`;
...
-- Database: `reviewdb`
--
CREATE DATABASE IF NOT EXISTS `reviewdb` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `reviewdb`;
...
(1, 'Ramesh', 32, 'Ahmedabad', 200000),
(2, 'Khilan', 25, 'Delhi', 150000),
(3, 'Kaushik', 23, 'Kota', 200000),
(4, 'Chaitali', 25, 'Mumbai', 650000),
(5, 'Hardik', 27, 'Bhopal', 850000),
(6, 'Komal', 22, 'MP', 450000),
(7, 'Muffy', 24, 'Indore', 1000000);
...
ALTER TABLE `customer`
  ADD KEY `customer_idx` (`ID`),
  ADD KEY `customer_index` (`ID`,`age`,`salary`);

--
-- Indexes for table `orders`
--
ALTER TABLE `orders`
  ADD KEY `order_index` (`OID`,`Date`,`Amount`);
--
-- Database: `test`
--
...
--
CREATE DATABASE IF NOT EXISTS `tokopakaian` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `tokopakaian`;
